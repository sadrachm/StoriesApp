...
export const Story2Screen: FC<StackScreenProps<NavigatorParamList, "story2">> = observer(
  ({ navigation }) => {
    ...
    return (
      <View testID="WelcomeScreen" style={FULL}>
        ...
        <Screen style={CONTAINER} preset="scroll" backgroundColor={color.transparent}>
          ...
          />
          <StoryTemplate title="Little Red Riding Hood" data={storyContent} />
        </Screen>
      </View>
    )
  },
